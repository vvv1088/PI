...
/* 用户管理 */
/* v83.1(V 定):Users 只有一种 —— Name/Username/Role/操作,一张表。
 * 系统 2 账号是过渡期水管,不上桌面:收进「Edit user」抽屉的一个可选字段(见 openUserEditor);
 * 审计对人不依赖它(X-MIS-User 直接带 MIS username)。 */
